...
#define IS_VERBOSE_DEBUG_GPD                        false       // verbose debug printouts for Ground Profile Derivator (1/GPD call)
...
#define IS_VERBOSE_GPD_LOGGING                      001        // log GPD every GPD-call, not just once a second
...
#define IS_IGNORE_FFC_OUTPUT                        0000        // true: we might have an ffc, giving output data, but we don't feed it onto altitude ctrl
...
#define LAST_CODE_CHANGE                    "2020-02-16 19:53+01:00"    // TODO: frequently update after changes
